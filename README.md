...
## Environments
- Preview: https://main--manasmaji-da-test11--aemysites.aem.page/
- Live: https://main--manasmaji-da-test11--aemysites.aem.live/
...
1. Open the `manasmaji-da-test11` directory in your favorite IDE and start coding :)
